...
import {useNotifications} from "../core/hook/use-dashboard.tsx";


const Admin = () => {
    const [sidebarOpen, setSidebarOpen] = useState(false);
    const { notifications } = useNotifications();
    const newTickets = notifications?.results.newTickets;
    const isCurrentEvent = notifications?.results.isCurrentEvent;
    const aStyle = "flex font-medium items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group";
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="/admin/events"
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Evenements</span>
                                {isCurrentEvent &&
